...
| S05-10 | Indemnización | US-019 | RF-005 / RF-018 | CA-013 | — | POST `/api/v1/siniestros/{id}/pagos` | `pago` | Implementado y probado | La indemnización se cubre mediante la funcionalidad de pago y la transición `AUTORIZADO → INDEMNIZADO`, con resultado económico y trazabilidad de la operación | Mantener la implementación y evidencia de pruebas |
