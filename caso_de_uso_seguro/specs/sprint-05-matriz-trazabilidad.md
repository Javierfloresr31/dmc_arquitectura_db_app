...
| S05-02 | Aprobar u observar presupuesto/cambio | US-012 | RF-015 | CA-010 | RN-006 | POST `/api/v1/siniestros/{id}/autorizaciones` / POST `/api/v1/presupuestos/{id}/observaciones` | `autorizacion` | Listo para implementación | La decisión funcional y la representación contractual mínima de la observación están definidas | Implementar únicamente la observación definida y preservar autorización/idempotencia |
